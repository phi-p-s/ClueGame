...
public class FileInitTest {
	...
	public void testRoomLabels() {
		...
		assertEquals("Jupiter 02", board.getRoom('J').getName() );
		...
		assertEquals("Classroom", board.getRoom('R').getName() );
		assertEquals("Office", board.getRoom('O').getName() );
		assertEquals("Maintenance Deck", board.getRoom('M').getName() );
		assertEquals("MedBay", board.getRoom('Y').getName() );
	}
